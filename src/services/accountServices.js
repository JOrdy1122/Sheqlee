...
//             now.setDate(now.getDate() - DELETION_PERIOD)
//         );

//         // Find all requests older than 30 days
...
//                 await Freelancer.findByIdAndDelete(
//                     request.account_Id
//                 );
//                 console.log(
//                     `Freelancer ${request.account_Id} deleted.`
//                 );
...
//                 );
//                 console.log(
//                     `Company ${request.account_Id} deleted.`
//                 );
//             }
